...
private fun getMapLifecycleObserver(mapView: MapView): LifecycleEventObserver =
    LifecycleEventObserver { _, event -> {
            when (event) {
                ...
                Lifecycle.Event.ON_START -> mapView.onCreate(Bundle())
                Lifecycle.Event.ON_RESUME -> mapView.onCreate(Bundle())
                Lifecycle.Event.ON_PAUSE -> mapView.onCreate(Bundle())
                Lifecycle.Event.ON_STOP -> mapView.onCreate(Bundle())
                Lifecycle.Event.ON_DESTROY -> mapView.onCreate(Bundle())
